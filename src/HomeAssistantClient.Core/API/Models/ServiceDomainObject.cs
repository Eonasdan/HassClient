...
public class ServiceDomainObject
{
    ...
    [JsonIgnore]
    public ServiceObject? this[string service] => Services.GetValueOrDefault(service);
    ...
    /// </summary>
    public override string ToString() => $"Service Domain: {Domain} ({Services.Count} service(s))";
}