...
/// </summary>
[PublicAPI]
public class Calendar : BaseHttpContent
{
    /// <summary>
    /// Gets or sets the Attendee list, if applicable.
    /// </summary>
    public List<CalendarPerson> Attendees { get; set; } = [];
...
/// </summary>
[PublicAPI]
public class CalendarReminderOverride
{
    /// <summary>
...
public class CalendarReminders
{
    ...
    /// </summary>
    public List<CalendarReminderOverride> Overrides { get; set; } = [];
}