...
namespace HassClient.Core.Models.RegistryEntries.Modifiable
{
    ...
    public abstract class ModifiablePropertyBase<T> : IModifiableProperty
    {
        ...
        protected ModifiablePropertyBase(string name)
        {
            Name = name;
        }
        ...
        /// </param>
        protected ModifiablePropertyBase(string name, Func<T, bool>? validationFunc, string? validationExceptionMessage = null)
            : this(name)
        {
